...
- (void)setArrCondition:(NSArray *)arrCondition {
    ...
    [YZViewManager viewManagerWithTextAndView:self data:_arrCondition error:nil withText:@"该产品暂无筛选" block:^{
...
//    PlaceHolderNoDataView *holderView = [[PlaceHolderNoDataView alloc] initWithFrame:CGRectMake(0, 0, S_W, 400) title:@" 您还没有订单"];
