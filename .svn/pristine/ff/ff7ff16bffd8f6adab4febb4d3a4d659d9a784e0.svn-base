    ...
    if (!_type) {
        switch (indexPath.row) {
            case 0: {
                ...
                _tfMobileLogin.growingAttributesDonotTrackValue = NO;
            ...
            case 1: {
                ...
                _tfPasswordLogin.growingAttributesDonotTrackValue = NO;
                break;
            }
            case 2: {
        ...
        switch (indexPath.row) {
            case 0: {
                ...
                _tfCodeRegister.growingAttributesDonotTrackValue = NO;
            ...
            case 1: {
                ...
                _tfImageCode.growingAttributesDonotTrackValue = NO;
    ...
    if (_tfMobileRegister.text.length && _tfCodeRegister.text.length && _tfPasswordRegister.text.length && _tfPasswordConfirm.text.length) {
        [YZHttpApiManager apiRegisterWithParameters:@{@"mobile"          : _tfMobileRegister.text,
                                  ...
                                  completionHandler:^(id response, NSError *error) {
                                      ...
                                      UILabel *lbl = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, S_W, S_H - 64)];
    ...
    if (_tfMobileLogin.text.length && _tfPasswordLogin.text.length) {
        ...
        [YZHttpApiManager apiLoginWithParameters:@{@"mobile"  : _tfMobileLogin.text,
                               ...
                               completionHandler:^(id response, NSError *error) {
                                   ...
                                   [_tfMobileLogin resignFirstResponder];
                                   [_tfPasswordLogin resignFirstResponder];
                                   UILabel *lbl = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, S_W, S_H - 64)];
                                   lbl.textAlignment = NSTextAlignmentCenter;
                                   lbl.font = BigFont;
                                   lbl.text = @"登录成功...";
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"segue_setting_agreement"]) {
        [(YZNewsDetailVC *)segue.destinationViewController setUrl:[NSString stringWithFormat:@"%@agreement", url_base]];
